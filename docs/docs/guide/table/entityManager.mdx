...
This method is used to build a retrieve item operation. `Entity.transactionGet(primaryKey, options?)` used separately won't make a DynamoDB API call. You need to pass it to [`transactionGet(transactions, options?)`](/docs/guide/transactions#transactiongettransactions-options) function. This allows to retrieve multiple items in a single transaction.
...
This method is used to build an insert item operation. `Entity.transactionPut(item, options?)` used separately won't make a DynamoDB API call. You need to pass it to [`transactionWrite(transactions, options?)`](/docs/guide/transactions#transactionwritetransactions-options) function. This allows to insert multiple items in a single transaction
...
| Name                    | Description                                                                                                                                                                                                                                                                  | Type                                                                                                                                                        | Default     |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `overwrite`             | `TransactItems.Put` DynamoDB operation overwrites items on insertion by default. If you want to prevent overwrites use [`Entity.transactionCreate(item, options?)`](/docs/guide/entity/methods#entitytransactioncreateitem-options) instead, or set overwrite prop to false. | `boolean`                                                                                                                                                   | `true`      |
| `condition`             | This is an optional instance of a `Condition` for the save. Item won't be inserted in case condition fails.                                                                                                                                                                  | `Condition`                                                                                                                                                 | `undefined` |
...
This method is almost identical to [`Entity.transactionPut(item, options?)`](/docs/guide/entity/methods#entitytransactionputitem-options). The only difference being that `Entity.transactionCreate(item, options?)` won't overwrite existing item in DynamoDB (overwrite is set to `false` as default).

## Entity.transactionUpdate(primaryKey, props, options?)

### Description

This method is used to build an update item operation. `Entity.transactionUpdate(primaryKey, props, options?)` used separately won't make a DynamoDB API call. You need to pass it to [`transactionWrite(transactions, options?)`](/docs/guide/transactions#transactionwritetransactions-options) function. This allows to update multiple items in a single transaction.
...
This method is used to build a delete item operation. `Entity.transactionDelete(primaryKey, options?)` used separately won't make a DynamoDB API call. You need to pass it to [`transactionWrite(transactions, options?)`](/docs/guide/transactions#transactionwritetransactions-options) function. This allows to delete multiple items in a single transaction.
...
This method is used to build a `conditionCheck` when running a transaction. `Entity.transactionCondition(primaryKey, conditionInstance)` used separately won't make a DynamoDB API call. You need to pass it to [`transactionWrite(transactions, options?)`](/docs/guide/transactions#transactionwritetransactions-options) function. This allows add multiple condition to a single transaction.
