...
**`transactions`**: `TransactionGet[]` - Array of get operations generated with [`EntityManager.transactionGet(primaryKey, options?)`](/docs/guide/entity/methods#entitytransactiongetprimarykey-options) method.
...
| Method                                                                                                                                                   | Description                                     |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| [`EntityManager.transactionPut(item, options?)`](/docs/guide/entity/methods#entitytransactionputitem-options)                                            | Insert an item to DynamoDB.                     |
| [`EntityManager.transactionCreate(item, options?)`](/docs/guide/entity/methods#entitytransactioncreateitem-options)                                      | Insert an item to DynamoDB (without overwrite). |
| [`EntityManager.transactionUpdate(primaryKey, props, options?)`](/docs/guide/entity/methods#entitytransactionupdateprimarykey-props-options)             | Update an item in DynamoDB.                     |
| [`EntityManager.transactionDelete(primaryKey, options?)`](/docs/guide/entity/methods#entitytransactiondeleteprimarykey-options)                          | Delete an item in DynamoDB.                     |
| [`EntityManager.transactionCondition(primaryKey, conditionInstance)`](/docs/guide/entity/methods#entitytransactionconditionprimarykey-conditioninstance) | Condition for the transaction.                  |
...
const transactions = await transactionWrite(
  [
    ...
    KeyValueManager.transactionCondition({ key: 'key5' }, KeyValue.condition().attribute('key').eq('key5')),
  ],
);
// OR
const transactions = await transactionWrite(
