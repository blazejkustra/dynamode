...
| Method                                                                                                                                                        | Description                                     |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| [`EntityManager.transaction.put(item, options?)`](/docs/guide/table/entityManager#entitytransactionputitem-options)                                            | Insert an item to DynamoDB.                     |
| [`EntityManager.transaction.create(item, options?)`](/docs/guide/table/entityManager#entitytransactioncreateitem-options)                                      | Insert an item to DynamoDB (without overwrite). |
| [`EntityManager.transaction.update(primaryKey, props, options?)`](/docs/guide/table/entityManager#entitytransactionupdateprimarykey-props-options)             | Update an item in DynamoDB.                     |
| [`EntityManager.transaction.delete(primaryKey, options?)`](/docs/guide/table/entityManager#entitytransactiondeleteprimarykey-options)                          | Delete an item in DynamoDB.                     |
| [`EntityManager.transaction.condition(primaryKey, conditionInstance)`](/docs/guide/table/entityManager#entitytransactionconditionprimarykey-conditioninstance) | Condition for the transaction.                  |
