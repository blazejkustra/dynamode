...
[User](/docs/guide/entity/modeling) is an example class that extends [Entity](/docs/guide/entity/methods).
...
User.condition().attribute('email');
...
:::caution
Typescript error: Argument of type '"unknownProperty"' is not assignable to parameter of type: `"username" | "partitionKey" | "sortKey" | "email" | "config" | "config.isAdmin" | friends.${number}`
:::
...
```ts
User.condition().attribute('username').between('blazej', 'clazej'); // Resulting in: `username BETWEEN blazej AND clazej`
```
...
User.condition().attribute('username').eq('blazej').and.parenthesis(
  User.condition()
    .attribute('email').eq('blazej@gmail.com')
    .attribute('email').eq('blazej@icloud.com')
); // username = blazej AND ( email = blazej@gmail.com OR email = blazej@icloud.com )
```
...
User.condition().attribute('username').eq('blazej').or.condition(
  User.condition()
    .attribute('email').eq('blazej@gmail.com')
    .attribute('email').eq('blazej@icloud.com')
); // username = blazej OR email = blazej@gmail.com OR email = blazej@icloud.com 
```
...
User.condition().attribute('username').eq('blazej').and.attribute('email').eq('blazej@gmail.com'); // username = blazej AND email = blazej@gmail.com
User.condition().attribute('username').eq('blazej').attribute('email').eq('blazej@gmail.com'); // username = blazej AND email = blazej@gmail.com
```
...
```ts
User.condition().attribute('username').eq('blazej').or.attribute('email').eq('blazej@gmail.com'); // username = blazej OR email = blazej@gmail.com
```
