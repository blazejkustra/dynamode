...
- It can be created locally (meaning that is not yet saved in DynamoDB) with [entity constructor](/docs/guide/managers/entityManager#new-entityprops), 
- It can be already stored in DynamoDB (e.g. [`EntityManager.get(primaryKey, options?)`](/docs/guide/managers/entityManager#entitygetprimarykey-options) or [`EntityManager.put(item, options?)`](/docs/guide/managers/entityManager#entityputitem-options)).
...
- To create an instance of Entity Manager use [`TableManager.entityManager(entity?)`](/docs/guide/managers/tableManager#tablemanagerentitymanagerentity) method.

## new Entity(props)

### Description

Entity constructor is used to initialize an item for a given model. When you construct an item using `new Entity(props)` the item is only created locally, meaning that it is not yet saved in DynamoDB. If you want to save it to the table use for example [`EntityManager.put(item, options?)`](/docs/guide/managers/entityManager#entityputitem-options) method.
...
**`primaryKey`**: `{ [partitionKey]: string | number; [sortKey]?: string | number }` - Primary key of the item you want to retrieve. `[partitionKey]` and `[sortKey]` are inferred from the [`new TableManager(tableEntity, tableMetadata)`](/docs/guide/managers/tableManager#new-tablemanagertableentity-tablemetadata) function.
...
This method is almost identical to [`EntityManager.put(item, options?)`](/docs/guide/managers/entityManager#entityputitem-options). The only difference being that `EntityManager.create(item, options?)` won't overwrite existing item in DynamoDB (overwrite is set to `false` as default).
...
**`primaryKey`**: `{ [partitionKey]: string | number; [sortKey]?: string | number }` - Primary key of the item you want to update. `[partitionKey]` and `[sortKey]` are inferred from the [`metadata(tableMetadata)`](/docs/guide/managers/tableManager#tablemanagertableentitymetadatatablemetadata) function.
...
**`primaryKey`**: `{ [partitionKey]: string | number; [sortKey]?: string | number }` - Primary key of the item you want to delete. `[partitionKey]` and `[sortKey]` are inferred from the [`new TableManager(tableEntity, tableMetadata)`](/docs/guide/managers/tableManager#new-tablemanagertableentity-tablemetadata) function.
...
**`primaryKeys`**: `Array<{ [partitionKey]: string | number; [sortKey]?: string | number }>` - Primary keys of the items you want to retrieve. `[partitionKey]` and `[sortKey]` are inferred from the [`new TableManager(tableEntity, tableMetadata)`](/docs/guide/managers/tableManager#new-tablemanagertableentity-tablemetadata) function.
...
**`primaryKeys`**: `Array<{ [partitionKey]: string | number; [sortKey]?: string | number }>` - Primary keys of the items you want to delete. `[partitionKey]` and `[sortKey]` are inferred from the [`new TableManager(tableEntity, tableMetadata)`](/docs/guide/managers/tableManager#new-tablemanagertableentity-tablemetadata) function.
...
| Name                    | Description                                                                                                                                                                                                                                                                                  | Type                                                                                                                                                        | Default     |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `overwrite`             | `TransactItems.Put` DynamoDB operation overwrites items on insertion by default. If you want to prevent overwrites use [`EntityManager.transaction.create(item, options?)`](/docs/guide/managers/entityManager#entitytransactioncreateitem-options) instead, or set overwrite prop to false. | `boolean`                                                                                                                                                   | `true`      |
| `condition`             | This is an optional instance of a `Condition` for the save. Item won't be inserted in case condition fails.                                                                                                                                                                                  | `Condition`                                                                                                                                                 | `undefined` |
...
This method is almost identical to [`EntityManager.transaction.put(item, options?)`](/docs/guide/managers/entityManager#entitytransactionputitem-options). The only difference being that `EntityManager.transaction.create(item, options?)` won't overwrite existing item in DynamoDB (overwrite is set to `false` as default).
...
**`primaryKey`**: `{ [partitionKey]: string | number; [sortKey]?: string | number }` - Primary key of the item you want to update. `[partitionKey]` and `[sortKey]` are inferred from the [`new TableManager(tableEntity, tableMetadata)`](/docs/guide/managers/tableManager#new-tablemanagertableentity-tablemetadata) function.
